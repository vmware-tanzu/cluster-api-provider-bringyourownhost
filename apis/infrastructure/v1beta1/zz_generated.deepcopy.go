...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BootstrapTokenValidator) DeepCopyInto(out *BootstrapTokenValidator) {
	*out = *in
	if in.decoder != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapTokenValidator.
func (in *BootstrapTokenValidator) DeepCopy() *BootstrapTokenValidator {
	if in == nil {
		return nil
	}
	out := new(BootstrapTokenValidator)
	in.DeepCopyInto(out)
	return out
}
