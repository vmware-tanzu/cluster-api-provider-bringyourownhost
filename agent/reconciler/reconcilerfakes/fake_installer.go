...
func (fake *FakeInstaller) Install(arg1 string, arg2 string, arg3 string) error {
...
func (fake *FakeInstaller) InstallCalls(stub func(string, string, string) error) {
	fake.installMutex.Lock()
...
func (fake *FakeInstaller) Uninstall(arg1 string, arg2 string, arg3 string) error {
...
func (fake *FakeInstaller) UninstallCalls(stub func(string, string, string) error) {
	fake.uninstallMutex.Lock()
	defer fake.uninstallMutex.Unlock()
	fake.UninstallStub = stub
}

func (fake *FakeInstaller) UninstallArgsForCall(i int) (string, string, string) {
	fake.uninstallMutex.RLock()
	defer fake.uninstallMutex.RUnlock()
