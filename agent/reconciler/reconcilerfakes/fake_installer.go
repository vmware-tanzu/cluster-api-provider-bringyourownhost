...
type FakeInstaller struct {
	...
	UninstallStub        func(string) error
...
func (fake *FakeInstaller) Install(arg1 string) error {
...
func (fake *FakeInstaller) InstallCalls(stub func(string) error) {
	fake.installMutex.Lock()
	defer fake.installMutex.Unlock()
	fake.InstallStub = stub
}

func (fake *FakeInstaller) InstallArgsForCall(i int) string {
	fake.installMutex.RLock()
	defer fake.installMutex.RUnlock()
...
func (fake *FakeInstaller) Uninstall(arg1 string) error {
...
func (fake *FakeInstaller) UninstallCalls(stub func(string) error) {
	fake.uninstallMutex.Lock()
	defer fake.uninstallMutex.Unlock()
	fake.UninstallStub = stub
}

func (fake *FakeInstaller) UninstallArgsForCall(i int) string {
	fake.uninstallMutex.RLock()
	defer fake.uninstallMutex.RUnlock()
