...
type ubuntu_20_4_pkg_1_22 struct {
	installer
}

func (u *ubuntu_20_4_pkg_1_22) Init() {
	u.AddSteps([]step{
		u.CreateSwapStep(),
		u.CreateFirewallStep()})
}

func (u *ubuntu_20_4_pkg_1_22) InitSteps() {
	u.AddSteps([]step{
		u.CreateStep(
...
func (u *ubuntu_20_4_pkg_1_22) CreateSwapStep() step {
	return u.CreateStep(
		"echo disabling swap Ubuntu 20.04",
		"echo enabling swap Ubuntu 20.04")
}

func (u *ubuntu_20_4_pkg_1_22) CreateFirewallStep() step {
	return u.CreateStep(
