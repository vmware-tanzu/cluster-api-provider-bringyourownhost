...
func (u *ubuntu_20_4_1_tkg_1_22) Init() {
	u.AddSteps([]step{
		u.CreateSwapStep(),      //ubuntu_20_4_1 override
		u.CreateFirewallStep()}) //ubuntu_20_4
}

func (u *ubuntu_20_4_1_tkg_1_22) InitSteps() {
	u.ubuntu_20_4_tkg_1_22.InitSteps()
...
func (u *ubuntu_20_4_1_tkg_1_22) CreateSwapStep() step {
	return u.CreateStep(
