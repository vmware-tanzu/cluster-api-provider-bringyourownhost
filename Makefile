...
cluster-templates-e2e: kustomize
	...
	$(KUSTOMIZE) build $(BYOH_TEMPLATES)/v1beta1/templates/e2e/topology --load-restrictor LoadRestrictionsNone > $(BYOH_TEMPLATES)/v1beta1/templates/e2e/topology/cluster-template-cc.yaml
