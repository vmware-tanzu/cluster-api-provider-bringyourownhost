...
var _ = BeforeSuite(func() {
	...
	reconciler = &ByoMachineReconciler{
		Client:  k8sClient,
		Tracker: remote.NewTestClusterCacheTracker(logf.NullLogger{}, clientFake, scheme.Scheme, client.ObjectKey{Name: testCluster.Name, Namespace: testCluster.Namespace}),
	}
